                ...
                <form name="kardex" method="post" >
                    ...
                    <table height="140" border="1">
                        ...
                        <tr>
                            <td>Oficina</td>
                            <td>
                                <select id="Oficina" style="width: 400px; height: 30px" class="myselect">
                                    <?php
                                    $rs2 = mysqli_query($cn, "SELECT * FROM oficina where Id > 0 order by Descripcion");
        ...
        $(document).ready(function () {
            ...
            $('#btn_aceptar').click(function () {
                ...
                if (document.getElementById('FechaFinal').value.trim() == '') {
                    alert('Error!, debe elegir una  Fecha de Final');
                    return false;
                }

                $.post('reporte_oficina_aceptar.php',
                        {
