...
<td><a href="#" onClick="javascript:autoSelect('<?php echo $row["id_auto"];?>','<?php echo $row["automovil"];?>','<?php echo $row["equipo"];?>','<?php echo $row["placa"];?>');"><?php echo $row["placa"]; ?></td></a>
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><?php echo $row["equipo"]; ?></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td align="center"><?php echo $row["automovil"]; ?></td>
</tr>
<?php
$cont++;
