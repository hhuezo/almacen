...
if (isset($_GET["txt_nombre"])) {
  $sql = "SELECT * FROM departamento where nom_dto like '%".$_GET['txt_nombre']."%'";
  ...
  <?php
	$cont=1;
	  while($rs = $result->fetch_array())
		...
		<td><a href="#" onClick="javascript:departamentoSelect('<?php echo $rs[0];?>','<?php echo $rs[1];?>');"><?php echo $rs[1]; ?>
		</a></td>
		</tr>
		<?php
		$cont++;
