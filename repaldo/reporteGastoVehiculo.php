...
<body>
		<center>
<h2>REPORTE POR VEHICULO</h2>	


<form name="reporte_oficina" action="reporteGastoVehiculo_aceptar.php" method="post">
...
<!--
  ...
  <tr>
    <td height="47"  class="texto"><div align="left" ><span>Fecha Inicio</span>:</div></td>
    <td>
  ...
  <tr>
    <td height="47"  class="texto"><div align="left">Fecha Fin</div></td>
    <td>
