...
<form name="reporte_oficina" action="reporte_oficinas_cuentas_aceptar.php" method="post">
...
<!--
  ...
  <tr>
    <td height="61"  class="texto"><div align="left" ><span>Fecha Inicio</span>:</div></td>
    <td>
