...
<form name="reporte_oficina" action="reporte_oficina_aceptar.php" method="post">
...
<table>
  ...
  <tr>
	...
	<input type="text" name="txt_departamento" id="txt_departamento" readonly value='<?php echo $nombre_departamento;?>' size="50" 
  ...
  <tr>
    <td height="36"  class="texto"><div align="left" ><span>Fecha Inicio</span>:</div></td>
    <td>
  ...
  <tr>
    <td height="36"  class="texto"><div align="left">Fecha Fin</div></td>
    <td>
  ...
  <tr>
    <td height="22" colspan="2"> 
        ...
        <center><input type="submit" name="aceptar" value="Aceptar" onClick="
         if (reporte_oficina.txt_nombre_dto.value==''){
        alert('Por favor, no dejar el departamento en blanco')
        return false;
        }       
