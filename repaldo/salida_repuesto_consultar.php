<html>
    ...
    <body>
        ...
        session_start();
        if (isset($_POST["descargo_editar"]) || isset($_SESSION['descargo'])) {
            if (isset($_POST["descargo_editar"])) {
                $descargo = $_POST["descargo_editar"];
                ...
                if ($numFilas > 0) {
                    ...
                    <table border='0' align='center' >
                        <tr class="row" bgcolor=#e5eecc>
                            <td align="center" colspan="11"><strong>DESCARGO No: <?php echo $descargo; ?></strong></td>
                        </tr>
