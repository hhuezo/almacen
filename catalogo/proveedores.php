...
$rs = mysqli_query($cn, "SELECT * FROM proveedor WHERE Id > 0");
?>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="container">
            <div class="login" align="center">
                ...
                <a href="proveedores_nuevo.php"><button  class="btn btn-primary">Nuevo Proveedor</button></a>
                            ...
                            if (mysqli_num_rows($rs) > 0) {
                                ...
                                while ($row = mysqli_fetch_array($rs)) {
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <a href="proveedores_modificar.php?Id=<?php echo $row['Id']; ?>"> <input type="button" class="btn btn-success" value="Modificar"></a>
                                        </td>
