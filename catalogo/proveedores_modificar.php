...
if (isset($_GET["Id"])) {
    ...
    $rs = mysqli_query($cn, "SELECT * FROM proveedor  where Id = " . $_GET["Id"]);
                ...
                <div class="login" align="center">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                        ...
                        <table height="200"  align="center">
                            ...
                            <tr>
                                <td >Proveedor</td>
                                <td>&nbsp;<input type="text" id="Proveedor" value="<?php echo $row["Descripcion"] ?>"  style="width: 400px; height: 30px"></td>
                                <td></td>
                            </tr>     
                            ...
                            <tr align="center">                           
                                <td colspan="2">
                                    ...
                                    <a href="proveedores.php"> <input type="button" class="btn btn-warning"  value="Cancelar"/></a>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#btn_aceptar').click(function () {
                    ...
                    if (document.getElementById('Proveedor').value.trim() == '') {
                        alert('Error!, Digite el Proveedor');
                        return false;
                    }
