...
$rs = mysqli_query($cn, "SELECT Id,Codigo,Descripcion,Alias,Numero,Activo FROM cuenta WHERE id > 0");
?>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="container">
            <div class="login" align="center">
                ...
                <a href="cuenta_nuevo.php"><button  class="btn btn-primary">Nueva Cuenta</button></a>
                            ...
                            if (mysqli_num_rows($rs) > 0) {
                                ...
                                while ($row = mysqli_fetch_array($rs)) {
                                    ...
                                    <tr align="center">
                                        ...
                                        <td>
                                            <a href="cuenta_modificar.php?Id=<?php echo $row['Id']; ?>"> <input type="button" class="btn btn-success" value="Modificar"></a>
                                        </td>
